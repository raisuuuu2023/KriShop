...
const ProductCard = ({ product, addToCart, buyNow }) => {
  return (
    <div className="flex-1 min-w-[calc(25%-20px)] max-w-[calc(25%-20px)] bg-white h-[350px] rounded-lg overflow-hidden shadow-md transition-transform duration-200 text-center hover:scale-103">
      <Image
        src={product.image} 
        alt={product.name} 
