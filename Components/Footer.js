...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-5 px-[5%] flex justify-between flex-wrap">
      <div className="flex-1 min-w-[calc(33.33%-20px)] max-w-[calc(33.33%-20px)] my-2 mx-2 text-center">
